...
{
    public partial class stock_addRaw : Form
    {
        //SqlConnection conn;
        string imgLocation = ""; //To Save the location of the picture uploading to the database
        ...
        private void stock_addRaw_Load(object sender, EventArgs e)
        {
            ...
            //Gets the last row first cell values to assign a new id
            int s = dba.getMax()+1;
            label13.Text = "STK"+Convert.ToString(s);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.SelectedIndex != 0 && comboBox2.SelectedIndex != 0 && comboBox3.SelectedIndex != 0 && textBox2.Text != "" && textBox3.Text != "" && textBox1.Text != "" && textBox6.Text!="")
                {
                ...
                else
                {
                    ...
                    double qp = up * qu;
                    double requan = Convert.ToDouble(textBox6.Text);
                if (dba.AddRawDetails(si, mt, um, qu, up, qp, al, aq, rol, remarks, image,requan))
                {
        ...
        {
            string s = pictureBox3.ImageLocation;
            comboBox2.SelectedIndex=0;
            comboBox3.SelectedIndex = 0;
            comboBox1.SelectedIndex = 0;
            textBox1.Text = "";
